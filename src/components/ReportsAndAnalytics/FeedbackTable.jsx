...
const FeedbackTable = ({ feedback }) => {
  return (
    <div className="mt-5 bg-[#3AD1F0] rounded-lg shadow-lg overflow-hidden overflow-x-scroll lg:overflow-x-hidden">
        ...
        <tbody className="bg-white">
          {feedback.map((item) => (
            <tr key={item.id}>
              ...
              <td className="text-start text-nowrap px-4 py-2">{item.date}</td>
            </tr>
          ))}
        </tbody>
      </table>
